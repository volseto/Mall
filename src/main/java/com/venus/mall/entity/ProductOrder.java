...
public class ProductOrder {
    ...
    private String productOrder_receiver; //收货人姓名
    private String productOrder_mobile; //收货人电话号码
    private Date productOrder_pay_date; //支付日期
    private Date productOrder_delivery_date; //发货日期
    private Date productOrder_confirm_date; //确认日期
    private Byte productOrder_status; //订单状态
    private User productOrder_user; //订单对应客户
